      ...
      <div className="container">
        ...
        <div className="section-title-two text-center sec-title-animation animation-style1">
          <div className="section-title-two__tagline-box justify-content-center">
            ...
            <span className="section-title-two__tagline">Industries We Serve</span>
          </div>
          <h2 className="section-title-two__title title-animation">
            <TextAnimation text='Delivering tailored technology solutions' textColor='black' isSpan={false} />
            <TextAnimation text='across diverse industries to enhance performance, security, and growth.' textColor='#5c2b7a' isSpan={false} />
