            ...
            <div className="container">
                ...
                <div className="section-title-two text-center sec-title-animation animation-style1">
                    <div className="section-title-two__tagline-box justify-content-center">
                        ...
                        <span className="section-title-two__tagline">Latest Insights & Technology Updates</span>
                    </div>
                    <h2 className="section-title-two__title title-animation">
                        <TextAnimation text='Stay informed with expert insights, industry trends, and the' textColor='black' isSpan={false} />
                        <TextAnimation text={`latest innovations in IT, telecom, and digital transformation.`} textColor='#5c2b7a' isSpan={false} />
                    </h2>
                </div>
