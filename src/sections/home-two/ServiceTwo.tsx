            ...
            <div className="container">
                ...
                <div className="section-title-two text-center sec-title-animation animation-style1">
                    <div className="section-title-two__tagline-box justify-content-center">
                        ...
                        <span className="section-title-two__tagline">Our Core IT & Infrastructure Services</span>
                    </div>
                    <h2 className="section-title-two__title title-animation">
                        <TextAnimation text='Delivering secure, scalable, and' textColor='black' isSpan={false} />
                        <TextAnimation text='high-performance technology solutions for modern businesses' textColor='#5c2b7a' isSpan={false} />
                    ...
                    {servicesTow.map((service: ServicesTow) => (
                        ...
                        >
                            <div className="services-two__single">
                                ...
                                <p className="services-two__text" dangerouslySetInnerHTML={{ __html: service.description }} />
