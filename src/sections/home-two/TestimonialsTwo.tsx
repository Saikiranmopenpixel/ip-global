...
// Import images
import shapeImg from "../../assets/images/shapes/testimonial-one-shape-1.png";
import starImg from "../../assets/images/shapes/testimonial-one-star.png";
import type { Swiper as SwiperType } from 'swiper';
import { Swiper, SwiperSlide } from 'swiper/react';
import { Navigation, Autoplay } from 'swiper/modules';
import { testimonials } from '../../contents/testimonials/testimonials';
import type { Testimonial } from '../../contents/testimonials/type';
            ...
            <div className="container">
                <div className="section-title text-center sec-title-animation animation-style1">
                    ...
                    <h2 className="section-title__title title-animation">
                        <TextAnimation text='Trusted by businesses for delivering reliable and' textColor='black' />
                        <TextAnimation text='impactful technology solutions.' textColor='#5c2b7a'/>
                    </h2>
                </div>
