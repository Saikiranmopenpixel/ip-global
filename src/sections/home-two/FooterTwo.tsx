...
import footerLogo from '../../assets/images/resources/logo.png';
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                                        <div className="footer-widget-two__about">
                                            <div className="footer-widget-two__about-logo">
                                                ...
                                                <p>IP Global Services is a trusted provider of IT infrastructure, telecom solutions, and digital transformation services, helping businesses build secure, scalable, and high-performance technology environments.</p>
                                            </div>
                                    ...
                                    <div className="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                                        <div className="footer-widget-two__services">
                                            <h4 className="footer-widget-two__title">Get In Touch</h4>
                                            ...
                                            <ul className="footer-widget-two__get-in-touch-list list-unstyled">
                                                <li>
                                                    ...
                                                    <div className="text">
                                                        ...
                                                        <p><b>IPGlobal Services</b><br />
                                              Flat No. 207, Pearls Best Heights-I <br /> Netaji Subhash Place Pitampura<br />
                                              New Delhi – 110034 India
                                                ...
                                                <li>
                                                    ...
                                                    <div className="text">
                                                        <p>
                                                            <a href="mailto:info@ipgs.net">info@ipgs.net</a>
                                                        </p>
                                                    </div>
                                                </li>
                                                <li>
                                                    ...
                                                    <div className="text">
                                                        <p>
                                                            <a href="tel:+911146548309">+91 11 4654 8309</a>
                                                        </p>
                                                    </div>
                                                </li>
                                            </ul>
...
<p className="site-footer-two__copyright-text">
  &copy; {new Date().getFullYear()} <b>IPGlobal Services</b>. &nbsp; All rights reserved - Designed by{' '}
  <a 
    href="https://openpixelweb.com/" 
    target="_blank" 
    rel="noreferrer"
    style={{ color: '#0db79a' }}
  >
